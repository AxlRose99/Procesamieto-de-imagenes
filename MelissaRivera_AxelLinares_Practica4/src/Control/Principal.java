...
public class Principal extends javax.swing.JFrame {
    ...
    JFileChooser save;
    Mat image,image2,imageGa,imageNeg,imageNeg2,imageBin,imageBin2,imageNF,imageAvg,imageGaussian,imageMedian,imageRota,imageRota2,imageSobel,imageSobel2,imageLaplace,imageLaplace2,imageCanny,imageCanny2,imageFourier,imageFourier2;
    BufferedImage imag;
    int umbral=120,valorB=0,valorC=0,valorNeg=0,valorBin=0,valorRota,rotacion,valorSobel,valorLaplace,valorCanny,valorFourier;
    double escala;
    ...
    private void initComponents() {
        ...
        sobel = new javax.swing.JRadioButton();
        laplace = new javax.swing.JRadioButton();
        canny = new javax.swing.JRadioButton();
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(rotar, javax.swing.GroupLayout.Alignment.TRAILING))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void brilloStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_brilloStateChanged
        ...
        if(contraste.getValue()==0 && gamma.getValue()==0 && negativo.isSelected()==false && binariza.isSelected()==false && averaging.getValue()==0 && gaussian.getValue()==0 && median.getValue()==0 && rotar.isSelected()==false && sobel.isSelected()==false && laplace.isSelected()==false && canny.isSelected()==false && fourier.isSelected()==false){
            if(level>0){
                valorB=level;
    ...
    private void contrasteStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_contrasteStateChanged
        ...
        if(brillo.getValue()==0 && gamma.getValue()==0 && negativo.isSelected()==false && binariza.isSelected()==false && averaging.getValue()==0 && gaussian.getValue()==0 && median.getValue()==0 && rotar.isSelected()==false && sobel.isSelected()==false && laplace.isSelected()==false && canny.isSelected()==false && fourier.isSelected()==false){
            if(level<0){
                valorC=level;
                level=level*5;
    ...
    private void negativoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_negativoActionPerformed
        if(negativo.isSelected()==true){
            if(brillo.getValue()==0 && contraste.getValue()==0 && gamma.getValue()==0 && binariza.isSelected()==false && averaging.getValue()==0 && gaussian.getValue()==0 && median.getValue()==0 && rotar.isSelected()==false && sobel.isSelected()==false && laplace.isSelected()==false && canny.isSelected()==false && fourier.isSelected()==false){
                valorNeg=1;
    ...
    private void gammaStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_gammaStateChanged
        ...
        if(contraste.getValue()==0 && brillo.getValue()==0 && negativo.isSelected()==false && binariza.isSelected()==false && averaging.getValue()==0 && gaussian.getValue()==0 && median.getValue()==0 && rotar.isSelected()==false && sobel.isSelected()==false && laplace.isSelected()==false && canny.isSelected()==false && fourier.isSelected()==false){
            if(level>0){
                g=level*1.05;
                gamma(image.clone(),g);
            }
    ...
    private void binarizaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_binarizaActionPerformed
        if(binariza.isSelected()==true){
            if(brillo.getValue()==0 && contraste.getValue()==0 && gamma.getValue()==0 && negativo.isSelected()==false && averaging.getValue()==0 && gaussian.getValue()==0 && median.getValue()==0 && rotar.isSelected()==false && sobel.isSelected()==false && laplace.isSelected()==false && canny.isSelected()==false && fourier.isSelected()==false){
                valorBin=1;
    ...
    private void averagingStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_averagingStateChanged
        ...
        if(brillo.getValue()==0 && contraste.getValue()==0 && gamma.getValue()==0 && negativo.isSelected()==false && binariza.isSelected()==false && gaussian.getValue()==0 && median.getValue()==0 && rotar.isSelected()==false && sobel.isSelected()==false && laplace.isSelected()==false && canny.isSelected()==false && fourier.isSelected()==false){
...
//                    imageGa=imageAvg.clone();
    ...
    private void gaussianStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_gaussianStateChanged
        ...
        if(brillo.getValue()==0 && contraste.getValue()==0 && gamma.getValue()==0 && negativo.isSelected()==false && binariza.isSelected()==false && averaging.getValue()==0 && median.getValue()==0 && rotar.isSelected()==false && sobel.isSelected()==false && laplace.isSelected()==false && canny.isSelected()==false && fourier.isSelected()==false){
    ...
    private void medianStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_medianStateChanged
        ...
        if(brillo.getValue()==0 && contraste.getValue()==0 && gamma.getValue()==0 && negativo.isSelected()==false && binariza.isSelected()==false && averaging.getValue()==0 && gaussian.getValue()==0 && rotar.isSelected()==false && sobel.isSelected()==false && laplace.isSelected()==false && canny.isSelected()==false && fourier.isSelected()==false){
    ...
    private void rotarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rotarActionPerformed
        ...
        if(rotar.isSelected()==true){
            if(grad>0 && grad<360 && esca>=.1 && esca<=.9){
                escala=esca;
                rotacion=grad;
                if(brillo.getValue()==0 && contraste.getValue()==0 && gamma.getValue()==0 && negativo.isSelected()==false && binariza.isSelected()==false && averaging.getValue()==0 && gaussian.getValue()==0 && median.getValue()==0 && sobel.isSelected()==false && laplace.isSelected()==false && canny.isSelected()==false && fourier.isSelected()==false){
                valorRota=1;
    ...
    private void sobelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sobelActionPerformed
        if(sobel.isSelected()==true){
            if(brillo.getValue()==0 && contraste.getValue()==0 && gamma.getValue()==0 && binariza.isSelected()==false && negativo.isSelected()==false && averaging.getValue()==0 && gaussian.getValue()==0 && median.getValue()==0 && rotar.isSelected()==false && laplace.isSelected()==false && canny.isSelected()==false && fourier.isSelected()==false){
                valorSobel=1;
                Mat sob = new Mat();
                Sobel(image.clone(),sob,-1,1,0);
                setImage(sob);
                image2=sob.clone();
            } 
            else{
                imageSobel=image2.clone();
                
                if(gamma.getValue()>0){
                    valorSobel=2;
                    imageSobel2=imageGa.clone();
                    
                    Mat sob = new Mat();
                    Sobel(image2.clone(),sob,-1,1,0);
                    image2=sob.clone();
                    
                    Mat sob2=new Mat();
                    Sobel(imageGa.clone(),sob2,-1,1,0);
                    imageGa=sob2.clone();
                    setImage(sob2);
                }
                else if(averaging.getValue()>0 || gaussian.getValue()>0 || median.getValue()>0 ){
                    valorSobel=3;
                    imageSobel2=imageNF.clone();
                    ...
                    Mat sob2=new Mat();
                    Sobel(imageNF.clone(),sob2,-1,1,0);
                    imageNF=sob2.clone();
                    setImage(sob2);  
                }
                else{
             ...
             switch (valorSobel) {
                case 1:
                    ...
                    break;
                case 2:
                    image2=imageSobel.clone();
                    imageGa=imageSobel2.clone();
                    setImage(imageGa);
                    break;
                case 3:
                    image2=imageSobel.clone();
                    imageNF=imageSobel2.clone();
                    setImage(imageNF);
                    break;
                case 4:
                    image2=imageSobel.clone();
    ...
    private void laplaceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_laplaceActionPerformed
        if(laplace.isSelected()==true){
            if(brillo.getValue()==0 && contraste.getValue()==0 && gamma.getValue()==0 && binariza.isSelected()==false && negativo.isSelected()==false && averaging.getValue()==0 && gaussian.getValue()==0 && median.getValue()==0 && rotar.isSelected()==false && sobel.isSelected()==false && canny.isSelected()==false && fourier.isSelected()==false){
                valorLaplace=1;
                Mat aux = new Mat();
                Laplacian(image.clone(),aux,-1);
                setImage(aux);
                image2=aux.clone();
            }
            else{
                imageLaplace=image2.clone();
                
                if(gamma.getValue()>0){
                    valorLaplace=2;
                    imageLaplace2=imageGa.clone();
                    
                    Mat aux = new Mat();
                    Laplacian(image2.clone(),aux,-1);
                    image2=aux.clone();
                    
                    Mat aux2=new Mat();
                    Laplacian(imageGa.clone(),aux2,-1);
                    imageGa=aux2.clone();
                    setImage(aux2);
                }
                else if(averaging.getValue()>0 || gaussian.getValue()>0 || median.getValue()>0 ){
                    valorLaplace=3;
                    imageLaplace2=imageNF.clone();
                    ...
                    Mat aux2=new Mat();
                    Laplacian(imageNF.clone(),aux2,-1);
                    imageNF=aux2.clone();
                    setImage(aux2); 
                }
                else{
             ...
             switch (valorLaplace) {
                case 1:
                    ...
                    break;
                case 2:
                    image2=imageLaplace.clone();
                    imageGa=imageLaplace2.clone();
                    setImage(imageGa);
                    break;
                case 3:
                    image2=imageLaplace.clone();
                    imageNF=imageLaplace2.clone();
                    setImage(imageNF);
                    break;
                case 4:
                    image2=imageLaplace.clone();
    ...
    private void cannyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cannyActionPerformed
        if(canny.isSelected()==true){
            if(brillo.getValue()==0 && contraste.getValue()==0 && gamma.getValue()==0 && binariza.isSelected()==false && negativo.isSelected()==false && averaging.getValue()==0 && gaussian.getValue()==0 && median.getValue()==0 && rotar.isSelected()==false && sobel.isSelected()==false && laplace.isSelected()==false && fourier.isSelected()==false){
                valorCanny=1;
                Mat aux = new Mat();
                Canny(image.clone(),aux,10,100,3,true);
                setImage(aux);
                image2=aux.clone();
            }
            else{
                imageCanny=image2.clone();
                
                if(gamma.getValue()>0){
                    valorCanny=2;
                    imageCanny2=imageGa.clone();
                    
                    Mat aux = new Mat();
                    Canny(image2.clone(),aux,10,100,3,true);
                    image2=aux.clone();
                    
                    Mat aux2=new Mat();
                    Canny(imageGa.clone(),aux2,10,100,3,true);
                    imageGa=aux2.clone();
                    setImage(aux2);
                }
                else if(averaging.getValue()>0 || gaussian.getValue()>0 || median.getValue()>0 ){
                    valorCanny=3;
                    imageCanny2=imageNF.clone();
                    ...
                    Mat aux2=new Mat();
                    Canny(imageNF.clone(),aux2,10,100,3,true);
                    imageNF=aux2.clone();
                    setImage(aux2); 
                }
                else{
             ...
             switch (valorCanny) {
                case 1:
                    ...
                    break;
                case 2:
                    image2=imageCanny.clone();
                    imageGa=imageCanny2.clone();
                    setImage(imageGa);
                    break;
                case 3:
                    image2=imageCanny.clone();
                    imageNF=imageCanny2.clone();
                    setImage(imageNF);
                    break;
                case 4:
                    image2=imageCanny.clone();
    ...
    private void fourierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fourierActionPerformed
        if(fourier.isSelected()==true){
            if(brillo.getValue()==0 && contraste.getValue()==0 && gamma.getValue()==0 && binariza.isSelected()==false && negativo.isSelected()==false && averaging.getValue()==0 && gaussian.getValue()==0 && median.getValue()==0 && rotar.isSelected()==false && sobel.isSelected()==false && laplace.isSelected()==false && canny.isSelected()==false){
                valorFourier=1;
                image2=fourier(image.clone());
            }
            else{
                imageFourier=image2.clone();
                
                if(gamma.getValue()>0){
                    valorFourier=2;
                    imageFourier2=imageGa.clone();

                    image2=fourier(image2.clone());;

                    imageGa=fourier(imageGa.clone());;
                }
                else if(averaging.getValue()>0 || gaussian.getValue()>0 || median.getValue()>0 ){
                    valorFourier=3;
                    imageFourier2=imageNF.clone();

                    image2=fourier(image2.clone());;

                    imageNF=fourier(imageNF.clone());;
                }
                else{
                    valorFourier=4;
             ...
             switch (valorFourier) {
                case 1:
                    ...
                    break;
                case 2:
                    image2=imageFourier.clone();
                    imageGa=imageFourier2.clone();
                    setImage(imageGa);
                    break;
                case 3:
                    image2=imageFourier.clone();
                    imageNF=imageFourier2.clone();
                    setImage(imageNF);
                    break;
                case 4:
                    image2=imageFourier.clone();
    ...
    private void histogramaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_histogramaActionPerformed
        ...
        Histogram.image=imag;
        his.display();
    }//GEN-LAST:event_histogramaActionPerformed
    
    private Mat fourier(Mat imageFou){
            Mat gray=new Mat();
            Imgproc.cvtColor(imageFou.clone(), gray, Imgproc.COLOR_RGB2GRAY );
    ...
    private void selectImage(){
        ...
        try{
            ...
            canny.setEnabled(true);
            fourier.setEnabled(true);
            histograma.setEnabled(true);
...
//            setImage2(newImage);
    ...
    private javax.swing.JRadioButton canny;
    ...
    private javax.swing.JRadioButton laplace;
    ...
    private javax.swing.JRadioButton sobel;
